# General_Config/Ayanami0-configs 覆写配置

## 📍 来源
- **路径**: `HenryChiao/mihomo_yamls/THEYAMLS/General_Config/Ayanami0-configs`
- **类型**: 外部自动同步
- **用途**: 通用配置 - Ayanami0-configs 作者维护
